...
crossover_mapping=parameters.crossover_mapping
nb_eval=parameters.nb_eval
ideal_results=parameters.GetIdealResultsData()
Strongly_Typed_Crossover_degree=parameters.Strongly_Typed_Crossover_degree
Substitute_Mutation=parameters.Substitute_Mutation
treeRules = parameters.treeRules
adfOrdered = parameters.adfOrdered
